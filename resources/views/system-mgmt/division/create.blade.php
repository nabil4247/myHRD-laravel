    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="modal-title" id="exampleModalLongTitle" style="font-weight:bolder; text-transform:uppercase; font-family: 'Times New Roman', Times, serif; color:red"> Tambah Divisi Form</h3>
                </div>
        ...
        <div class="modal-footer">
          ...
          <button type="sumbit" class="btn btn-primary">Simpan Divisi</button>
        </div>
    </form>
      </div>
    </div>
