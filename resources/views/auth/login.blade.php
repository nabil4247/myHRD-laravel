...
<html>
    <head>
        ...
        <title>myHRD | Aplikasi Manajemen Karyawan</title>
...
<div class="login-box">
  <div class="login-logo">
    <a href="#"><b>myHRD </b> EMS</a>
    <img src="{{ asset("/bower_components/AdminLTE/dist/img/myHRD-logo.png") }}" class="user-image" alt="User Image">
  </div>
  <!-- /.login-logo -->
